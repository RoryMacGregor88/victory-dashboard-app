export type DeliverableSupplySummaryData = {
  'Large Sites - With Planning Permission': number;
  'Non Self Contained Accomodation With Planning Permission': number;
  'Windfall Allowance From Small Sites': number;
  'Sites on the Brownfield Land Site': number;
  startYear: number;
}[];

const DeliverableSupplySummaryData = [
  {
...
export default DeliverableSupplySummaryData;
